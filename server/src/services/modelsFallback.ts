/**
 * Temporary hardcoded model data for Phase 1.
 * This file will be deleted in Phase 3 when the Supabase DB is wired up.
 */
...
export const modelDatabase: Record<TaskType, ModelRecommendation[]> = {
  "text-generation": [
    ...
    },
    {
      ...
      tradeoffs: [
        ...
        "Smaller context window than Llama",
      ],
    },
    {
      id: "phi-3-mini",
  ...
  classification: [
    ...
    },
    {
      ...
      tradeoffs: [
        ...
        "Best for simpler classification tasks",
      ],
    },
  ],
  summarization: [
  ...
  "question-answering": [
    {
      ...
      score: 93,
      reasoning:
        "Excellent for complex, multi-hop reasoning with strong context understanding.",
      tradeoffs: [
        "Higher latency for simple questions",
  ...
  "code-generation": [
    {
      ...
      tradeoffs: [
        ...
        "License restrictions for large deployments",
      ],
    },
    {
      id: "starcoder2-7b",
      ...
      tradeoffs: [
        "Slightly lower than Code Llama on benchmarks",
  ...
  embedding: [
    ...
    },
    {
      ...
      tradeoffs: [
        "Slightly lower English-only benchmarks",
        "Requires prefix formatting",
      ],
    },
    {
      id: "gte-small",
      ...
      tradeoffs: [
        "Lower accuracy ceiling",
        "Best for simpler retrieval tasks",
      ],
    },
  ],
};
...
export function getModelsForTask(taskType: string): {
  models: ModelRecommendation[];
  warningModel: ModelRecommendation;
} {
  const key = taskType as TaskType;
  const models = modelDatabase[key] ?? modelDatabase["text-generation"];
  const warningModel = warningModels[key] ?? warningModels["text-generation"];
  return { models, warningModel };
}
